...
15. **Próximos lotes:** conexão do pagamento de Acerto ao estado local, projeções locais, autenticação, integração com o banco e sincronização.
