...
14. **Próximos lotes:** conexão dos demais formulários ao estado local, projeções locais, autenticação, integração com o banco e sincronização.
